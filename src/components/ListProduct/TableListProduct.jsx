...
export const TableListProduct = () => {
  ...
  return (
    ...
    <h1 className="text-3xl font-bold flex mb-8 justify-start relative right-1/4 ml-20	" >Todas las Máquinas</h1>
    <AgregarMaquina/>
    </div>
      ...
      <tr key={product.id}>
        ...
        <td>
          <div className="flex items-center space-x-3">
            <div className="avatar">
              ...
              <img  src={'data:image/png;base64,' + product.productImages?.[0]?.productImage} alt="Avatar Tailwind CSS Component" />
              </div>
            </div>
            <div className="ml-8">
              <div className="font-bold ml-8">{product.name}</div>
              <div className='font-light ml-8'>{product.productType.description}</div>
              <div className="text-sm opacity-50 ml-8">{product.category}</div>
            </div>
          </div>
        </td>
        ...
        <th>
          <div className="dropdown dropdown-bottom dropdown-end">
            <label tabIndex={0} className="btn m-1 bg-inherit border-none">
              <svg
            ...
            >
              ...
              <li>
                <a className="text-red-600"  onClick={() => handleDeleteProduct(product.id)}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="18"
